    ...
    if (searchText === '') {
      ...
      let SearchBuyer = invoice.filter(invo => {
        if (searchText === searchText.toLowerCase()) {
          let buyer =
            invo.buyer.toLowerCase().indexOf(searchText.toLowerCase()) > -1
          return buyer
        } else {
          let buyer =
            invo.buyer.toUpperCase().indexOf(searchText.toUpperCase()) > -1
          return buyer
        }
      })
      this.setState({
                          ...
                          <Row>
                            ...
                            <Col lg={6} className='text-lg-right mt-4 mt-lg-0'>
                              ...
                              <ul className='list-unstyled mb-0'>
                                <li>
                                  <span>Order ID:</span>{' '}
                                  <strong>{viewInvoice.invoiceid}</strong>
                                </li>
                                <li>
                                ...
                                <li>
                                  ...
                                  <strong>
                                    ${viewInvoice.price + viewInvoice.tax + 50}
                                    .00
                                  </strong>
                                </li>
                              </ul>
                            ...
                            <table className='table mb-0'>
                              <tbody>
                                <tr className='ordered-item'>
                                  {typeof viewInvoice.pictures !=
                                  'undefined' ? (
                                    <td className='ordered-image'>
                                      <img
                                        // eslint-disable-next-line no-undef
                                        src={require(`../../assets/images/${viewInvoice.pictures}`)}
                                        className='img-fluid'
                                      />
                                    </td>
                                  ) : null}
