                ...
                <Col lg={12}>
                  <div className="woocommerce-Address">
                    <div className="woocommerce-Address-title">
                      ...
                      <a
                        className="add-user btn btn-primary ml-auto"
                        onClick={this.toggle}
                        href="#"
                      >
                        Add user
                    ...
                    <div className="woocommerce-Address-info mt-4">
                      <div className="table-responsive">
                        <table className="table table-striped collaboration-table mb-0">
                          <thead>
                            <tr>
                              <th>No</th>
                              <th>image</th>
                          ...
                          {collabroations.length > 0 ? (
                            <tbody>
                              {collabroations.map((collabro, index) => (
                                <tr key={index}>
                                  <td>{collabro.id}</td>
                                  <td>
                                    <img
                                      // eslint-disable-next-line no-undef
                                      src={require(`../../assets/images/testimonials/${collabro.image}`)}
                                      alt="profile"
                  ...
                  >
                    ...
                    <form onSubmit={this.AddUserSubmit.bind(this)}>
                      ...
                      <ModalFooter className="justify-content-start pt-4">
                        ...
                        <Button className="action-button no" href="#" onClick={this.toggle}>
                          Cancel
                        </Button>
                      </ModalFooter>
                    </form>
                  ...
                  >
                    ...
                    <ModalBody>Are You Sure You Want To Delete This User Permanently?</ModalBody>
