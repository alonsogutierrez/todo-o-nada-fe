                ...
                <div className="woocommerce-MyAccount-navigation">
                  ...
                  <Form className="login form">
                    ...
                    <div className="form-row">
                      <Input type="hidden" />
                      <Input type="hidden" />
                      <Button type="button" className="button" name="login" value="Log in">
                        Log in
                      </Button>
                ...
                <div className="my-account">
                  ...
                  <Form className="register form">
                    <div className="registration-info">
                      ...
                      Just fill in the fields below, and we will get a new account set up for you in
                    ...
                    <div className="privacy-policy-text">
                      <p>
                        ...
                        in our{' '}
                        <Link to="#" className="privacy-policy-link" target="_blank">
                          privacy policy
                        </Link>
                      </p>
                    </div>
                    <div className="woocommerce-FormRow form-row">
                      <Button type="button" className="button" name="register">
                        Register
                      </Button>
                    </div>
                  </Form>
