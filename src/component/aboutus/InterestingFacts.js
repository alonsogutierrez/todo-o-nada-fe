          ...
          <Col sm={12}>
            <div className="section-title text-center">
              ...
              <p className="text-center">
                Discover the best collection for autumn of Stylist Art. With so charming, modern and
                passionate, you certainly love this collection.
              </p>
            </div>
          </Col>
        </Row>
                ...
                <div className="ciyashop_info_box-icon">
                  <div className="ciyashop_info_box-icon-wrap">
                    <div className="ciyashop_info_box-icon-outer">
                      ...
                      >
                        <i className="fa fa-exchange" style={{ color: '#04d39f' }} />{' '}
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="ciyashop_info_box-content-wrap">
                    <div className="ciyashop_info_box-content-inner">
                      <div className="ciyashop_info_box-step-wrapper">
                        <span className="ciyashop_info_box-step">01 </span>
                      </div>
                      ...
                      <div className="ciyashop_info_box-description">
                        <p>
                          If something isn&apos;t your cup of tea then you can simply swap it for
                          another experience.
                        </p>
                      </div>
                    </div>
              ...
              <div className="ciyashop_info_box-inner clearfix">
                <div className="ciyashop_info_box-icon">
                  <div className="ciyashop_info_box-icon-wrap">
                    <div className="ciyashop_info_box-icon-outer">
                      ...
                      >
                        <i className="fa fa-retweet" style={{ color: '#04d39f' }} />{' '}
                      </div>
                    </div>
                  </div>
                </div>
                <div className="ciyashop_info_box-content">
                  <div className="ciyashop_info_box-content-wrap">
                    <div className="ciyashop_info_box-content-inner">
                      <div className="ciyashop_info_box-step-wrapper">
                        <span className="ciyashop_info_box-step">02 </span>
                      </div>
                      <h4 className="ciyashop_info_box-title" style={{ color: '#323232' }}>
                      ...
                      <div className="ciyashop_info_box-description">
                        <p>
                          Plenty of time to change your mind odio dignissimos ducimus qui blanditiis
                          praesentium.
                        </p>
                      </div>
                    </div>
              ...
              <div className="ciyashop_info_box-inner clearfix">
                <div className="ciyashop_info_box-icon">
                  <div className="ciyashop_info_box-icon-wrap">
                    <div className="ciyashop_info_box-icon-outer">
                      ...
                      >
                        <i className="fa fa-inbox" style={{ color: '#04d39f' }} />{' '}
                      </div>
                    </div>
                  </div>
                </div>
                <div className="ciyashop_info_box-content">
                  <div className="ciyashop_info_box-content-wrap">
                    <div className="ciyashop_info_box-content-inner">
                      <div className="ciyashop_info_box-step-wrapper">
                        <span className="ciyashop_info_box-step">03 </span>
                      </div>
                      <h4 className="ciyashop_info_box-title" style={{ color: '#323232' }}>
                        E-vouchers to inbox{' '}
                      </h4>
                      <div className="ciyashop_info_box-description">
                        <p>
                          Sent straight to your inbox within 2 hours many desktop publishing
                          packages.
                        </p>
                      </div>
                    </div>
              ...
              <div className="ciyashop_info_box-inner clearfix left-info-icon-bottom">
                <div className="ciyashop_info_box-icon">
                  <div className="ciyashop_info_box-icon-wrap">
                    <div className="ciyashop_info_box-icon-outer">
                      ...
                      >
                        <i className="fa fa-gift" style={{ color: '#04d39f' }} />{' '}
                      </div>
                    </div>
                  </div>
                </div>
                <div className="ciyashop_info_box-content">
                  <div className="ciyashop_info_box-content-wrap">
                    <div className="ciyashop_info_box-content-inner">
                      <div className="ciyashop_info_box-step-wrapper">
                        <span className="ciyashop_info_box-step">04 </span>
                      </div>
                      <h4 className="ciyashop_info_box-title" style={{ color: '#323232' }}>
                        Premium Gifts{' '}
                      </h4>
                      <div className="ciyashop_info_box-description">
                        <p>
                          Upgrade for £3.50 It has survived not only five centuries, but also the
              ...
              <div className="ciyashop_info_box-inner clearfix left-info-icon-bottom">
                <div className="ciyashop_info_box-icon">
                  <div className="ciyashop_info_box-icon-wrap">
                    <div className="ciyashop_info_box-icon-outer">
                      ...
                      >
                        <i className="fa fa-usd" style={{ color: '#04d39f' }} />{' '}
                      </div>
                    </div>
                  </div>
                </div>
                <div className="ciyashop_info_box-content">
                  <div className="ciyashop_info_box-content-wrap">
                    <div className="ciyashop_info_box-content-inner">
                      <div className="ciyashop_info_box-step-wrapper">
                        <span className="ciyashop_info_box-step">05 </span>
                      </div>
                      <h4 className="ciyashop_info_box-title" style={{ color: '#323232' }}>
                      ...
                      <div className="ciyashop_info_box-description">
                        <p>
                          We want to make sure you get the best deals on the web at vero eos et
                          accusamus
                        </p>
                      </div>
                    </div>
              ...
              <div className="ciyashop_info_box-inner clearfix left-info-icon-bottom">
                <div className="ciyashop_info_box-icon">
                  <div className="ciyashop_info_box-icon-wrap">
                    <div className="ciyashop_info_box-icon-outer">
                      ...
                      >
                        <i className="fa fa-truck" style={{ color: '#04d39f' }} />{' '}
                      </div>
                    </div>
                  </div>
                </div>
                <div className="ciyashop_info_box-content">
                  <div className="ciyashop_info_box-content-wrap">
                    <div className="ciyashop_info_box-content-inner">
                      <div className="ciyashop_info_box-step-wrapper">
                        <span className="ciyashop_info_box-step">06 </span>
                      </div>
                      <h4 className="ciyashop_info_box-title" style={{ color: '#323232' }}>
                        Ship the same day{' '}
                      </h4>
                      <div className="ciyashop_info_box-description">
                        <p>
                          Order an experience before 3pm and we&apos;ll get it in the post the same
                          day versions have evolved.
                        </p>
                      </div>
                    </div>
                  </div>
