        ...
        <Slider {...settings}>
          <div className='item'>
            <a href='#'>
              <div className='category-image'>
                <img
                  src={require(`../assets/images/shop/cat-01.png`)}
                  alt='cat'
                />
              </div>
          ...
          <div className='item'>
            <a href='#'>
              <div className='category-image'>
                <img
                  src={require(`../assets/images/shop/cat-02.png`)}
                  alt='cat'
                />
              </div>
              <div className='category-summary'>
          ...
          <div className='item'>
            <a href='#'>
              <div className='category-image'>
                <img
                  src={require(`../assets/images/shop/cat-03.png`)}
                  alt='cat'
                />
              </div>
              <div className='category-summary'>
          ...
          <div className='item'>
            <a href='#'>
              <div className='category-image'>
                <img
                  src={require(`../assets/images/shop/cat-04.png`)}
                  alt='cat'
                />
              </div>
              <div className='category-summary'>
          ...
          <div className='item'>
            <a href='#'>
              <div className='category-image'>
                <img
                  src={require(`../assets/images/shop/cat-05.png`)}
                  alt='cat'
                />
              </div>
              <div className='category-summary'>
...
ShopItemSlider.defaultProps = {
  settings: {}
}

ShopItemSlider.propTypes = {
