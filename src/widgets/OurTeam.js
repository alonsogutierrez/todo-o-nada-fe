          ...
          <div className='item'>
            <div className='team shadow'>
              <div className='team-images'>
                <img
                  className='img-fluid'
                  src={require(`../assets/images/team/img-01.jpg`)}
                />
              </div>
          ...
          <div className='item'>
            <div className='team shadow'>
              <div className='team-images'>
                <img
                  className='img-fluid'
                  src={require(`../assets/images/team/img-02.jpg`)}
                />
              </div>
              <div className='team-info'>
                <div className='team-description'>
          ...
          <div className='item'>
            <div className='team shadow'>
              <div className='team-images'>
                <img
                  className='img-fluid'
                  src={require(`../assets/images/team/img-03.jpg`)}
                />
              </div>
              <div className='team-info'>
                <div className='team-description'>
          ...
          <div className='item'>
            <div className='team shadow'>
              <div className='team-images'>
                <img
                  className='img-fluid'
                  src={require(`../assets/images/team/img-04.jpg`)}
                />
              </div>
              <div className='team-info'>
                <div className='team-description'>
          ...
          <div className='item'>
            <div className='team shadow'>
              <div className='team-images'>
                <img
                  className='img-fluid'
                  src={require(`../assets/images/team/img-05.jpg`)}
                />
              </div>
              <div className='team-info'>
                <div className='team-description'>
          ...
          <div className='item'>
            <div className='team shadow'>
              <div className='team-images'>
                <img
                  className='img-fluid'
                  src={require(`../assets/images/team/img-06.jpg`)}
                />
              </div>
              <div className='team-info'>
                <div className='team-description'>
          ...
          <div className='item'>
            <div className='team shadow'>
              <div className='team-images'>
                <img
                  className='img-fluid'
                  src={require(`../assets/images/team/img-07.jpg`)}
                />
              </div>
              <div className='team-info'>
                <div className='team-description'>
          ...
          <div className='item'>
            <div className='team shadow'>
              <div className='team-images'>
                <img
                  className='img-fluid'
                  src={require(`../assets/images/team/img-08.jpg`)}
                />
              </div>
              <div className='team-info'>
                <div className='team-description'>
