      ...
      <div className='container'>
          ...
          <Col sm={12}>
            <div className='section-title text-center'>
              ...
              <p className='text-center'>
                Discover the best collection for autumn of Stylist Art. With so
                charming, modern and passionate, you certainly love this
                collection.
              </p>
            </div>
          </Col>
        ...
        <Row className='align-items-center'>
                  ...
                  <div className='ciyashop_info_box-content-wrap'>
                    <div className='ciyashop_info_box-content-inner'>
                      ...
                      <div className='ciyashop_info_box-description'>
                        <p>
                          If something isn&apos;t your cup of tea then you can
                          simply swap it for another experience.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className='ciyashop_info_box-content'>
                  <div className='ciyashop_info_box-content-wrap'>
                    <div className='ciyashop_info_box-content-inner'>
                      ...
                      <div className='ciyashop_info_box-description'>
                        <p>
                          Plenty of time to change your mind odio dignissimos
                ...
                <div className='ciyashop_info_box-content'>
                  <div className='ciyashop_info_box-content-wrap'>
                    <div className='ciyashop_info_box-content-inner'>
                      ...
                      <div className='ciyashop_info_box-description'>
                        <p>
                          Sent straight to your inbox within 2 hours many
          ...
          <Col sm={4} className='d-none d-lg-block'>
            <img
              src={require(`../assets/images/about-us-1.png`)}
              className='img-fluid'
            />
          </Col>
          <Col lg={4} md={6}>
                ...
                <div className='ciyashop_info_box-content'>
                  <div className='ciyashop_info_box-content-wrap'>
                    <div className='ciyashop_info_box-content-inner'>
                      ...
                      <div className='ciyashop_info_box-description'>
                        <p>
                          Upgrade for £3.50 It has survived not only five
                ...
                <div className='ciyashop_info_box-content'>
                  <div className='ciyashop_info_box-content-wrap'>
                    <div className='ciyashop_info_box-content-inner'>
                      ...
                      <div className='ciyashop_info_box-description'>
                        <p>
                          Order an experience before 3pm and we&apos;ll get it
                          in the post the same day versions have evolved.
                        </p>
                      </div>
                    </div>
                  </div>
