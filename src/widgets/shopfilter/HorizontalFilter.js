            ...
            <div className="filters-wrapper">
                 {(!isMobile) ?
                    <div className="d-flex align-items-center">
                        <p className="mb-0 filter-title filter-by"><i className="fa fa-filter"></i> Filter by</p>
                                        ...
                                        return (
                                          ...
                                          >
                                            <input
                                              ...
                                              value={size}
                                              defaultChecked={
                                                sizeFilterValues.includes(size)
                                                  ? true
                                                  : false
                                              }
                                              className='form-check-input'
