      ...
      <Row className='row section-pb'>
        <Col md={6} className='mb-2 mb-sm-0'>
                ...
                <div className='ciyashop_banner-content-wrapper'>
                  <div className='ciyashop_banner-content-inner-wrapper'>
                    ...
                    <div className='ciyashop_banner-btn-wrap ciyashop_banner-btn-style-link ciyashop_banner-btn-shape-square'>
                      ...
                      <Link
                        to='/shop'
                        className='ciyashop_banner-btn inline_hover'
                      >
                        Shop Now
                      </Link>
                    </div>
          ...
          <div className='ciyashop_banner_wrapper'>
            <div className='ciyashop_banner ciyashop_banner-style-style-1 ciyashop_banner-effect-none'>
              <img
                className='ciyashop_banner-image img-fluid inline img-fluid'
                alt='Banner'
                ...
                <div className='ciyashop_banner-content-wrapper'>
                  <div className='ciyashop_banner-content-inner-wrapper'>
                    <div className='ciyashop_banner-label-wrap ciyashop_banner-text-wrap-1 ciyashop_banner-text-bg_color hidden-lg hidden-md hidden-sm hidden-xs'>
                      <div className='ciyashop_banner-label ciyashop_banner-lanel-yellow'>
                        {' '}
                        Sale
                      </div>
                    </div>
                    ...
                    <div className='ciyashop_banner-btn-wrap ciyashop_banner-btn-style-link ciyashop_banner-btn-shape-square justify-content-end'>
                      {' '}
                      <Link
                        to='/shop'
                        className='ciyashop_banner-btn inline_hover'
        ...
        <Col md={6} className='mt-4 mt-md-0'>
          <div
            className='ciyashop_banner_wrapper'
            style={{
              ...
              <div className='ciyashop_banner-content position-md-r ciyashop_banner-content-hleft ciyashop_banner-content-vtop'>
                <div className='ciyashop_banner-content-wrapper'>
                  <div className='ciyashop_banner-content-inner-wrapper'>
                    ...
                    <div className='ciyashop_banner-btn-wrap ciyashop_banner-btn-style-flat ciyashop_banner-btn-size-md ciyashop_banner-btn-shape-square'>
                      {' '}
                      <Link to='/shop' className='ciyashop_banner-btn'>
                        Buy now!
                      </Link>
                    </div>
                  </div>
